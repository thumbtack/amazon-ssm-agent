...
func (_m *SsmmdsAPI) AcknowledgeMessageWithContext(_a0 aws.Context, _a1 *ssmmds.AcknowledgeMessageInput, _a2 ...request.Option) (*ssmmds.AcknowledgeMessageOutput, error) {
	...
	var r0 *ssmmds.AcknowledgeMessageOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(aws.Context, *ssmmds.AcknowledgeMessageInput, ...request.Option) (*ssmmds.AcknowledgeMessageOutput, error)); ok {
...
func (_m *SsmmdsAPI) DeleteMessageWithContext(_a0 aws.Context, _a1 *ssmmds.DeleteMessageInput, _a2 ...request.Option) (*ssmmds.DeleteMessageOutput, error) {
	...
	var r0 *ssmmds.DeleteMessageOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(aws.Context, *ssmmds.DeleteMessageInput, ...request.Option) (*ssmmds.DeleteMessageOutput, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
...
func (_m *SsmmdsAPI) FailMessageWithContext(_a0 aws.Context, _a1 *ssmmds.FailMessageInput, _a2 ...request.Option) (*ssmmds.FailMessageOutput, error) {
	...
	var r0 *ssmmds.FailMessageOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(aws.Context, *ssmmds.FailMessageInput, ...request.Option) (*ssmmds.FailMessageOutput, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
...
func (_m *SsmmdsAPI) GetEndpointWithContext(_a0 aws.Context, _a1 *ssmmds.GetEndpointInput, _a2 ...request.Option) (*ssmmds.GetEndpointOutput, error) {
	...
	var r0 *ssmmds.GetEndpointOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(aws.Context, *ssmmds.GetEndpointInput, ...request.Option) (*ssmmds.GetEndpointOutput, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
...
func (_m *SsmmdsAPI) GetMessagesWithContext(_a0 aws.Context, _a1 *ssmmds.GetMessagesInput, _a2 ...request.Option) (*ssmmds.GetMessagesOutput, error) {
	...
	var r0 *ssmmds.GetMessagesOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(aws.Context, *ssmmds.GetMessagesInput, ...request.Option) (*ssmmds.GetMessagesOutput, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
...
func (_m *SsmmdsAPI) SendReplyWithContext(_a0 aws.Context, _a1 *ssmmds.SendReplyInput, _a2 ...request.Option) (*ssmmds.SendReplyOutput, error) {
	...
	var r0 *ssmmds.SendReplyOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(aws.Context, *ssmmds.SendReplyInput, ...request.Option) (*ssmmds.SendReplyOutput, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
